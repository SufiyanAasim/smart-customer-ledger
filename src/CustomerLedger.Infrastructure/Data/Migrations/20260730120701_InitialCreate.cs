        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewStatus = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BackupHistoryId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BackupHistories_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    ConcurrencyVersion = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerInteractionId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    BranchId = table.Column<int>(type: "int", nullable: false),
                    InteractionType = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerInteractions_AspNetUsers_RecordedByUserId",
                        column: x => x.RecordedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerInteractions_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "BranchId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalInstallmentAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstallmentPlans", x => x.InstallmentPlanId);
                    table.ForeignKey(
                        name: "FK_InstallmentPlans_AspNetUsers_ApprovedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    BranchId = table.Column<int>(type: "int", nullable: false),
                    PaymentNumber = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    PaymentStatus = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReceivedByUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReversedPaymentId = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_Payments_ReversedPaymentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InstallmentScheduleId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    InstallmentPlanId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstallmentSchedules", x => x.InstallmentScheduleId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_BranchId_CreatedAtUtc",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractions_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerInteractions_RecordedByUserId",
                table: "CustomerInteractions",
                column: "RecordedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_BranchId_Status_IsDeleted",
                table: "Customers",
                columns: new[] { "BranchId", "Status", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstallmentPlans_ApprovedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstallmentSchedules_InstallmentPlanId_InstallmentNumber",
                table: "InstallmentSchedules",
                columns: new[] { "InstallmentPlanId", "InstallmentNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InstallmentSchedules_Status_DueDate",
                table: "InstallmentSchedules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_BranchId_InvoiceStatus_InvoiceDate",
                table: "Invoices",
                columns: new[] { "BranchId", "InvoiceStatus", "InvoiceDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_CustomerId_PaymentStatus",
                table: "Invoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_InvoiceId_PaymentStatus",
                table: "Payments",
                columns: new[] { "InvoiceId", "PaymentStatus" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_ReversedPaymentId",
                table: "Payments",
